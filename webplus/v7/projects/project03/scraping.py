...
for i in range(10):
    try:
        btn_more = driver.find_element(by=By.CSS_SELECTOR,  value="#foodstar-front-location-curation-more-self > div > button")
        btn_more.click()
        time.sleep(5)
...
for place in places:
    ...
    headers = {
        "X-NCP-APIGW-API-KEY-ID": "[내 API ID]",
        "X-NCP-APIGW-API-KEY": "[내 API 시크릿키]"
    }
